  ...
  IF(FindSword_LIBS)
    ...
    IF(FindSword_INCS)
      ...
      ELSE()
        ...
        GET_FILENAME_COMPONENT(Sword_LIBRARY_DIRS "${FindSword_LIBS}" ABSOLUTE)
        SET(Sword_LIBRARIES "-lsword")
        SET(Sword_LDFLAGS "${Sword_LIBRARY_DIRS};${Sword_LIBRARIES}")
        SET(Sword_INCLUDE_DIRS "${FindSword_INCS}")
        SET(Sword_CFLAGS "${Sword_INCLUDE_DIRS}")
      ENDIF()
    ENDIF()
