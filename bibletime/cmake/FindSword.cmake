...
FIND_PATH(SWORD_LIBRARY_DIR	NAMES libsword.a PATHS ${TRIAL_LIBRARY_PATHS})
...
# First: try -lsword only
CHECK_SWORD_LINK_LIBRARIES("${CLUCENE_LIBRARY};${SWORD_LIBRARY}")
...
# Next: try -lsword -lcurl
	CHECK_SWORD_LINK_LIBRARIES("${CLUCENE_LIBRARY};${SWORD_LIBRARY};curl")

	IF(SWLINKER_CHECK_COMPILE_RESULT)
		MESSAGE(STATUS "Sword linker check compiled ok.")
		SET(SWORD_LIBRARY "${SWORD_LIBRARY};curl")
	ELSE(SWLINKER_CHECK_COMPILE_RESULT)
		MESSAGE(FATAL_ERROR "Sword linker check could NOT be compiled: ${SWLINKER_CHECK_COMPILE_OUTPUT}")
