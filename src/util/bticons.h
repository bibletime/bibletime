...
public: // fields:
    ...
    RegularIcon const icon_bulleted_list;
    ...
    RegularIcon const icon_edit_cut;
    RegularIcon const icon_edit_paste;
    ...
    RegularIcon const icon_highlight;
    RegularIcon const icon_import;
    RegularIcon const icon_info;
    RegularIcon const icon_insert_picture;
    RegularIcon const icon_insert_table;
    ...
    RegularIcon const icon_link;
    RegularIcon const icon_lock;
    RegularIcon const icon_manual;
    RegularIcon const icon_map;
    RegularIcon const icon_numbered_list;
    RegularIcon const icon_open_rich_text_editor;
    ...
    RegularIcon const icon_spell_check;
    ...
    OverlayedIcon const icon_calendar_add;
    ...
    OverlayedIcon const icon_dictionary_add;
    ...
    OverlayedIcon const icon_map_add;
    OverlayedIcon const icon_map_locked;
    OverlayedIcon const icon_questionable_add;
