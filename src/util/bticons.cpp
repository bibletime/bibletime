...
BtIcons::BtIcons()
    ...
    , icon_bulleted_list(QStringLiteral("bulleted_list.svg"))
    ...
    , icon_edit_cut(QStringLiteral("edit_cut.svg"))
    , icon_edit_paste(QStringLiteral("edit_paste.svg"))
    ...
    , icon_highlight(QStringLiteral("highlight.svg"))
    , icon_import(QStringLiteral("import.svg"))
    , icon_info(QStringLiteral("info.svg"))
    , icon_insert_picture(QStringLiteral("insert_picture.svg"))
    , icon_insert_table(QStringLiteral("insert_table.svg"))
    ...
    , icon_link(QStringLiteral("link.svg"))
    , icon_lock(QStringLiteral("lock.svg"))
    , icon_manual(QStringLiteral("manual.svg"))
    , icon_map(QStringLiteral("map.svg"))
    , icon_numbered_list(QStringLiteral("numbered_list.svg"))
    , icon_open_rich_text_editor(QStringLiteral("open_rich_text_editor.svg"))
    ...
    , icon_speaker(QStringLiteral("speaker.svg"))
    , icon_spell_check(QStringLiteral("spell_check.svg"))
    ...
    , icon_calendar_add(icon_calendar, icon_add)
    , icon_calendar_locked(icon_calendar, icon_lock)
    ...
    , icon_dictionary_add(icon_dictionary, icon_add)
    , icon_dictionary_locked(icon_dictionary, icon_lock)
    , icon_folder_add(icon_folder, icon_add)
    , icon_lexicon_add(icon_lexicon, icon_add)
    , icon_lexicon_locked(icon_lexicon, icon_lock)
    , icon_map_add(icon_map, icon_add)
    , icon_map_locked(icon_map, icon_lock)
    , icon_questionable_add(icon_questionable, icon_add)
    , icon_questionable_locked(icon_questionable, icon_lock)
