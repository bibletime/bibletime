...
*
* Copyright 2025 by the BibleTime developers.
...
BtTextToSpeechSettingsPage::BtTextToSpeechSettingsPage(CConfigurationDialog * parent)
    ...
    QStringList const availableEngines = QTextToSpeech::availableEngines();
...
void BtTextToSpeechSettingsPage::ttsLocaleChanged() {
    ...
    QVariant const userData = m_ttsLocaleComboBox->currentData();
