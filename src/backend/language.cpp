...
LanguageMap::LanguageMap() {
    ...
    */
    ...
    addLanguage({"ang"}, QT_TRANSLATE_NOOP("QObject", "Old English (ca.450-1100)"));
    ...
    addLanguage({"ell", "el"}, QT_TRANSLATE_NOOP("QObject", "Modern Greek (1453-)"));
    ...
    addLanguage({"enm"}, QT_TRANSLATE_NOOP("QObject", "Middle English (1100-1500)"));
    ...
    addLanguage({"grc"}, QT_TRANSLATE_NOOP("QObject", "Ancient Greek (to 1453)"));
    ...
    addLanguage({"zh-Hans"}, QT_TRANSLATE_NOOP("QObject", "Simplified Chinese"));
    addLanguage({"zh-Hant"}, QT_TRANSLATE_NOOP("QObject", "Traditional Chinese"));
