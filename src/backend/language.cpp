...
LanguageMap::LanguageMap() {
    ...
    */
    ...
    addLanguage({"cco"}, QT_TRANSLATE_NOOP("QObject", "Comaltepec Chinantec"));
    ...
    addLanguage({"chq"}, QT_TRANSLATE_NOOP("QObject", "Quiotepec Chinantec"));
    addLanguage({"chr"}, QT_TRANSLATE_NOOP("QObject", "Cherokee"));
    addLanguage({"chv", "cv"}, QT_TRANSLATE_NOOP("QObject", "Chuvash"));
    addLanguage({"chz"}, QT_TRANSLATE_NOOP("QObject", "Ozumacín Chinantec"));
    ...
    addLanguage({"cnl"}, QT_TRANSLATE_NOOP("QObject", "Lalana Chinantec"));
    addLanguage({"cnt"}, QT_TRANSLATE_NOOP("QObject", "Tepetotutla Chinantec"));
    ...
    addLanguage({"cso"}, QT_TRANSLATE_NOOP("QObject", "Sochiapan Chinantec"));
    ...
    addLanguage({"kmr"}, QT_TRANSLATE_NOOP("QObject", "Northern Kurdish"));
    addLanguage({"kmr-Cyrl"}, QT_TRANSLATE_NOOP("QObject", "Northern Kurdish (Cyrillic script)"));
    addLanguage({"kmr-Latn"}, QT_TRANSLATE_NOOP("QObject", "Northern Kurdish (Latin script)"));
    ...
    addLanguage({"mir"}, QT_TRANSLATE_NOOP("QObject", "Isthmus Mixe"));
    ...
    addLanguage({"mxq"}, QT_TRANSLATE_NOOP("QObject", "Juquila Mixe"));
    ...
    addLanguage({"ncl"}, QT_TRANSLATE_NOOP("QObject", "Michoacán Nahuatl"));
    ...
    addLanguage({"ngu"}, QT_TRANSLATE_NOOP("QObject", "Guerrero Nahuatl"));
    ...
    addLanguage({"nhy"}, QT_TRANSLATE_NOOP("QObject", "Northern Oaxaca Nahuatl"));
    ...
    addLanguage({"otq"}, QT_TRANSLATE_NOOP("QObject", "Querétaro Otomi"));
    ...
    addLanguage({"swh"}, QT_TRANSLATE_NOOP("QObject", "Swahili (Individual language)"));
