...
LanguageMap::LanguageMap() {
    ...
    */
    ...
    addLanguage({QStringLiteral("abk")}, QT_TRANSLATE_NOOP("QObject", "Abkhazian"));
    addLanguage({QStringLiteral("abq-Cyrl")}, QT_TRANSLATE_NOOP("QObject", "Abaza"));
    ...
    addLanguage({QStringLiteral("aqk")}, QT_TRANSLATE_NOOP("QObject", "Anuak"));
    addLanguage({QStringLiteral("ar-Arab-EG")}, QT_TRANSLATE_NOOP("QObject", "Arabic"));
    ...
    addLanguage({QStringLiteral("ben-Beng-IN")}, QT_TRANSLATE_NOOP("QObject", "Bengali"));
    ...
    addLanguage({QStringLiteral("cek")}, QT_TRANSLATE_NOOP("QObject", "Eastern Khanty"));
    ...
    addLanguage({QStringLiteral("cop-sa")}, QT_TRANSLATE_NOOP("QObject", "Sahidic Coptic"));
    //  addLanguage({QStringLiteral("co")}, QT_TRANSLATE_NOOP("QObject", "Corsican"));
    addLanguage({QStringLiteral("cs-Latn-CZ")}, QT_TRANSLATE_NOOP("QObject", "Czech"));
    ...
    addLanguage({QStringLiteral("cth")}, QT_TRANSLATE_NOOP("QObject", "Chothe Naga"));
    ...
    addLanguage({QStringLiteral("dng-Cyrl")}, QT_TRANSLATE_NOOP("QObject", "Dungan"));
    addLanguage({QStringLiteral("dnj")}, QT_TRANSLATE_NOOP("QObject", "Dan"));
    addLanguage({QStringLiteral("dnv")}, QT_TRANSLATE_NOOP("QObject", "Danu"));
    addLanguage({QStringLiteral("dug")}, QT_TRANSLATE_NOOP("QObject", "Duruma"));
    addLanguage({QStringLiteral("dwu")}, QT_TRANSLATE_NOOP("QObject", "Dhuwal"));
    addLanguage({QStringLiteral("dwy")}, QT_TRANSLATE_NOOP("QObject", "Dhuwaya"));
    //  addLanguage({QStringLiteral("dz")}, QT_TRANSLATE_NOOP("QObject", "Dzongkha"));
    addLanguage({QStringLiteral("ee-Latn-GH")}, QT_TRANSLATE_NOOP("QObject", "Ewe"));
    addLanguage({QStringLiteral("el"), QStringLiteral("gre"), QStringLiteral("ell")}, QT_TRANSLATE_NOOP("QObject", "Greek, Modern (1453-)"));
    addLanguage({QStringLiteral("en-Latn")}, QT_TRANSLATE_NOOP("QObject", "English"));
    ...
    addLanguage({QStringLiteral("esg")}, QT_TRANSLATE_NOOP("QObject", "Aheri Gondi"));
    addLanguage({QStringLiteral("es")}, QT_TRANSLATE_NOOP("QObject", "Spanish"));
    addLanguage({QStringLiteral("et-Latn-EE")}, QT_TRANSLATE_NOOP("QObject", "Estonian"));
    ...
    addLanguage({QStringLiteral("fa-Arab-IR")}, QT_TRANSLATE_NOOP("QObject", "Persian"));
    addLanguage({QStringLiteral("fa")}, QT_TRANSLATE_NOOP("QObject", "Persian"));
    addLanguage({QStringLiteral("fi-Latn-FI")}, QT_TRANSLATE_NOOP("QObject", "Finnish"));
    ...
    addLanguage({QStringLiteral("gyz")}, QT_TRANSLATE_NOOP("QObject", "Ge'ez"));
    addLanguage({QStringLiteral("ha-Latn-NG")}, QT_TRANSLATE_NOOP("QObject", "Hausa"));
    ...
    addLanguage({QStringLiteral("he-Hebr-IL")}, QT_TRANSLATE_NOOP("QObject", "Hebrew"));
    addLanguage({QStringLiteral("he")}, QT_TRANSLATE_NOOP("QObject", "Hebrew"));
    addLanguage({QStringLiteral("hi-Deva-IN")}, QT_TRANSLATE_NOOP("QObject", "Hindi"));
    addLanguage({QStringLiteral("hi")}, QT_TRANSLATE_NOOP("QObject", "Hindi"));
    addLanguage({QStringLiteral("hne-Deva-IN")}, QT_TRANSLATE_NOOP("QObject", "Chhattisgarhi"));
    //  addLanguage({QStringLiteral("ho")}, QT_TRANSLATE_NOOP("QObject", "Hiri Motu"));
    addLanguage({QStringLiteral("hr-Latn-HR")}, QT_TRANSLATE_NOOP("QObject", "Croatian"));
    addLanguage({QStringLiteral("hr")}, QT_TRANSLATE_NOOP("QObject", "Croatian"));
    addLanguage({QStringLiteral("hrw")}, QT_TRANSLATE_NOOP("QObject", "Warwar Feni"));
    addLanguage({QStringLiteral("ht")}, QT_TRANSLATE_NOOP("QObject", "Haitian Creole"));
    addLanguage({QStringLiteral("hu-Latn-HU")}, QT_TRANSLATE_NOOP("QObject", "Hungarian"));
    ...
    addLanguage({QStringLiteral("ig-Latn-NG")}, QT_TRANSLATE_NOOP("QObject", "Igbo"));
    //  addLanguage({QStringLiteral("ik")}, QT_TRANSLATE_NOOP("QObject", "Inupiaq"));
    addLanguage({QStringLiteral("ing-Cyrl")}, QT_TRANSLATE_NOOP("QObject", "Ingush"));
    addLanguage({QStringLiteral("iqw")}, QT_TRANSLATE_NOOP("QObject", "Ikwo"));
    addLanguage({QStringLiteral("is-Latn-IS")}, QT_TRANSLATE_NOOP("QObject", "Icelandic"));
    ...
    addLanguage({QStringLiteral("izz")}, QT_TRANSLATE_NOOP("QObject", "Izii"));
    ...
    addLanguage({QStringLiteral("ki-Latn-KE")}, QT_TRANSLATE_NOOP("QObject", "Kikuyu"));
    ...
    addLanguage({QStringLiteral("kk-Cyrl")}, QT_TRANSLATE_NOOP("QObject", "Kazakh"));
    ...
    addLanguage({QStringLiteral("kn-Knda-IN")}, QT_TRANSLATE_NOOP("QObject", "Kannada"));
    ...
    addLanguage({QStringLiteral("krc-Cyrl")}, QT_TRANSLATE_NOOP("QObject", "Karachay-Balkar"));
    //  addLanguage({QStringLiteral("ks")}, QT_TRANSLATE_NOOP("QObject", "Kashmiri"));
    addLanguage({QStringLiteral("ku-Arab-IQ")}, QT_TRANSLATE_NOOP("QObject", "Central Kurdish"));
    ...
    addLanguage({QStringLiteral("lbe-Cyrl")}, QT_TRANSLATE_NOOP("QObject", "Lak"));
    //  addLanguage({QStringLiteral("lb")}, QT_TRANSLATE_NOOP("QObject", "Letzeburgesch"));
    addLanguage({QStringLiteral("lg-Latn-UG")}, QT_TRANSLATE_NOOP("QObject", "Ganda"));
    addLanguage({QStringLiteral("lmo")}, QT_TRANSLATE_NOOP("QObject", "Lombard"));
    addLanguage({QStringLiteral("ln-Latn-CD")}, QT_TRANSLATE_NOOP("QObject", "Lingala"));
    ...
    addLanguage({QStringLiteral("lth")}, QT_TRANSLATE_NOOP("QObject", "Luthigh"));
    addLanguage({QStringLiteral("lt")}, QT_TRANSLATE_NOOP("QObject", "Lithuanian"));
    addLanguage({QStringLiteral("luo-Latn-KE")}, QT_TRANSLATE_NOOP("QObject", "Luo"));
    ...
    addLanguage({QStringLiteral("ml-Mlym-IN")}, QT_TRANSLATE_NOOP("QObject", "Malayalam"));
    ...
    addLanguage({QStringLiteral("mr-Deva-IN")}, QT_TRANSLATE_NOOP("QObject", "Marathi"));
    ...
    addLanguage({QStringLiteral("nb-Latn-NO")}, QT_TRANSLATE_NOOP("QObject", "Norwegian Bokmål"));
    ...
    addLanguage({QStringLiteral("ncq")}, QT_TRANSLATE_NOOP("QObject", "Northern Katang"));
    addLanguage({QStringLiteral("nd-Latn-ZW")}, QT_TRANSLATE_NOOP("QObject", "North Ndebele"));
    ...
    addLanguage({QStringLiteral("npi-Deva-NP")}, QT_TRANSLATE_NOOP("QObject", "Nepali"));
    ...
    addLanguage({QStringLiteral("nww")}, QT_TRANSLATE_NOOP("QObject", "Cwi Bwamu"));
    addLanguage({QStringLiteral("ny-Latn-MW")}, QT_TRANSLATE_NOOP("QObject", "Chichewa"));
    ...
    addLanguage({QStringLiteral("om-Ethi-ET")}, QT_TRANSLATE_NOOP("QObject", "Oromo"));
    addLanguage({QStringLiteral("om-Latn-ET")}, QT_TRANSLATE_NOOP("QObject", "Oromo"));
    ...
    addLanguage({QStringLiteral("oss-Cyrl")}, QT_TRANSLATE_NOOP("QObject", "Ossetian"));
    ...
    addLanguage({QStringLiteral("pl-Latn-PL")}, QT_TRANSLATE_NOOP("QObject", "Polish"));
    ...
    addLanguage({QStringLiteral("rmq")}, QT_TRANSLATE_NOOP("QObject", "Caló"));
    ...
    addLanguage({QStringLiteral("ru-Cyrl-RU")}, QT_TRANSLATE_NOOP("QObject", "Russian"));
    ...
    addLanguage({QStringLiteral("sk-Latn-SK")}, QT_TRANSLATE_NOOP("QObject", "Slovak"));
    ...
    addLanguage({QStringLiteral("sn-Latn-ZW")}, QT_TRANSLATE_NOOP("QObject", "Shona"));
    ...
    addLanguage({QStringLiteral("sr-Cyrl-RS")}, QT_TRANSLATE_NOOP("QObject", "Serbian"));
    addLanguage({QStringLiteral("sr-Latn-RS")}, QT_TRANSLATE_NOOP("QObject", "Serbian"));
    ...
    addLanguage({QStringLiteral("sty")}, QT_TRANSLATE_NOOP("QObject", "Siberian Tatar"));
    ...
    addLanguage({QStringLiteral("sw-Latn-KE")}, QT_TRANSLATE_NOOP("QObject", "Swahili"));
    ...
    addLanguage({QStringLiteral("ta-Taml-IN")}, QT_TRANSLATE_NOOP("QObject", "Tamil"));
    //  addLanguage({QStringLiteral("te")}, QT_TRANSLATE_NOOP("QObject", "Telugu"));
    addLanguage({QStringLiteral("te-Telu-IN")}, QT_TRANSLATE_NOOP("QObject", "Telugu"));
    addLanguage({QStringLiteral("tgj")}, QT_TRANSLATE_NOOP("QObject", "Tagin"));
    ...
    addLanguage({QStringLiteral("tkr-Latn")}, QT_TRANSLATE_NOOP("QObject", "Tsakhur"));
    ...
    addLanguage({QStringLiteral("tn-Latn-BW")}, QT_TRANSLATE_NOOP("QObject", "Tswana"));
    addLanguage({QStringLiteral("tn")}, QT_TRANSLATE_NOOP("QObject", "Tswana"));
    addLanguage({QStringLiteral("tr-Latn-FR")}, QT_TRANSLATE_NOOP("QObject", "Turkish"));
    ...
    addLanguage({QStringLiteral("twi-Latn-GH")}, QT_TRANSLATE_NOOP("QObject", "Twi"));
    ...
    addLanguage({QStringLiteral("tyv-Cyrl")}, QT_TRANSLATE_NOOP("QObject", "Tuvan"));
    ...
    addLanguage({QStringLiteral("uk-Cyrl-UA")}, QT_TRANSLATE_NOOP("QObject", "Ukrainian"));
    addLanguage({QStringLiteral("uk")}, QT_TRANSLATE_NOOP("QObject", "Ukrainian"));
    addLanguage({QStringLiteral("ur-Arab-PK")}, QT_TRANSLATE_NOOP("QObject", "Urdu"));
    ...
    addLanguage({QStringLiteral("uth")}, QT_TRANSLATE_NOOP("QObject", "ut-Hun"));
    ...
    addLanguage({QStringLiteral("vi-Zinh-VN")}, QT_TRANSLATE_NOOP("QObject", "Vietnamese"));
    ...
    addLanguage({QStringLiteral("xnj")}, QT_TRANSLATE_NOOP("QObject", "Ngoni"));
    ...
    addLanguage({QStringLiteral("yo-Latn-NG")}, QT_TRANSLATE_NOOP("QObject", "Yoruba"));
    addLanguage({QStringLiteral("yom-Latn-CD")}, QT_TRANSLATE_NOOP("QObject", "Yombe"));
    ...
    addLanguage({QStringLiteral("zbu")}, QT_TRANSLATE_NOOP("QObject", "Zbu"));
    addLanguage({QStringLiteral("zh-Hans-CN")}, QT_TRANSLATE_NOOP("QObject", "Chinese (Simplified)"));
    addLanguage({QStringLiteral("zh-Hans")}, QT_TRANSLATE_NOOP("QObject", "Chinese (Simplified)"));
    addLanguage({QStringLiteral("zh-Hant-HK")}, QT_TRANSLATE_NOOP("QObject", "Chinese (Traditional)"));
    addLanguage({QStringLiteral("zh-Hant")}, QT_TRANSLATE_NOOP("QObject", "Chinese (Traditional)"));
