...
void BibleTime::createMenuAndToolBar()
{
    ...
    bool visible = ! getBtConfig().value<bool>("gui/showToolbarsInEachWindow");
...
void BibleTime::initActions() {
    ...
    m_showTextAreaHeadersAction->setChecked(getBtConfig().value<bool>("gui/showTextWindowHeaders"));
    ...
    m_showMainWindowToolbarAction->setChecked(getBtConfig().value<bool>("gui/showMainToolbar"));
    ...
    m_showTextWindowNavigationAction->setChecked(getBtConfig().value<bool>("gui/showTextWindowNavigator"));
    ...
    m_showTextWindowModuleChooserAction->setChecked(getBtConfig().value<bool>("gui/showTextWindowModuleSelectorButtons"));
    ...
    m_showTextWindowToolButtonsAction->setChecked(getBtConfig().value<bool>("gui/showTextWindowToolButtons"));
    ...
    m_showFormatToolbarAction->setChecked(getBtConfig().value<bool>("gui/showFormatToolbarButtons"));
    ...
    m_toolbarsInEachWindow->setChecked(getBtConfig().value<bool>("gui/showToolbarsInEachWindow"));
    ...
    alignmentMode alignment = getBtConfig().value<alignmentMode>("gui/alignmentMode");
...
void BibleTime::initBackends() {
    ...
    backend->booknameLanguage(getBtConfig().value<QString>("language"));
